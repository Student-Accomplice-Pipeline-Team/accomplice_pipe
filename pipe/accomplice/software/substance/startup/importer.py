...
class SubstanceImporterWindow(QtWidgets.QMainWindow):
    ...
    def setup_UI(self):
        ...
        self.title = QtWidgets.QLabel(
            "Choose an asset, geo variant, and material variant to shade..."
        )
        ...
        if i.text() != "&Yes":
            ...
            if not os.path.isfile(mesh_path):
                ...
                self.mesh_warn.setText(
                    "The mesh file at "
                    + mesh_path
                    + " does not exist. Make sure you have exported from Studini."
                )
            ...
            meta.hierarchy[geo_variant][material_variant] = object.MaterialVariant(
                material_variant, {}
            )
    ...
    def import_button(self):
        ...
        if material_variant not in meta.hierarchy[geo_variant]:
            ...
            self.matvar_warn.setText(
                "You're about to create a new material variant in the pipeline under "
                + asset.name
                + "/"
                + geo_variant
                + "/"
            ...
            self.matvar_warn.setWindowTitle(
                "Create new material variant Substance file?"
            )
            self.matvar_warn.setText(
