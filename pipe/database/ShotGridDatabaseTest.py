...
class ShotGridDatabaseAssetTest(unittest.TestCase):
    ...
    def test_get_asset_list(self):
        ...
        self.assertEqual(
            ...
            + str([asset for asset in asset_list if asset_list.count(asset) > 1]),
...
def run_tests():
    ...
    tests.addTest(
        unittest.TestLoader().loadTestsFromTestCase(ShotGridDatabaseAssetTest)
    )
    tests.addTest(unittest.TestLoader().loadTestsFromTestCase(ShotGridDatabaseShotTest))
    tests.addTest(
        unittest.TestLoader().loadTestsFromTestCase(AsynchronousShotGridDatabaseTest)
    )
